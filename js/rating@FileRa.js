!function () {
    if ("undefined" == typeof BloggerRatingGenerator) {
        ...
        function r(t, r, l, i) {
            ...
            n.setAttribute("class", "BloggerStarRating"), "insertAfter" === l ? t.parentNode.insertBefore(n, t.nextSibling) : t.insertBefore(n, t.firstChild);
                ...
                if (e === i.length - 1)
                    for (let e = 0; e < s.length; e++) {
                        if (t.querySelector(s[e])) {
                            r(t.querySelector(s[e]), a, "top" === l.position ? "insertBefore" : "insertAfter", l);
                            break
                        }
                        if (e === s.length - 1) {
                            let t = document.createElement("div");
                            document.body.appendChild(t), t.style.display = "block", t.style.position = "fixed", t.style.left = "0", t.style.bottom = "0", t.style.background = "lightblue", t.style.borderTop = "1px solid black", r(t, a, "insertBefore", l)
                        }
                    }
            }
        }
        ...
        function i(e, l) {
            ...
            ! function t(e) {
                ...
                /.*\/\d{4}\/\d{2}\/.*\.html/.test(location.href.split("?")[0].split("#")[0]) ? l(t, starRatingSystemSettings.postPage) : /.*\/p\/.*\.html/.test(location.href.split("?")[0].split("#")[0]) ? l(t, starRatingSystemSettings.staticPage) : (i(t, starRatingSystemSettings.indexPage), setInterval(function () {
